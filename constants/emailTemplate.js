                                                                    ...
                                                                    <td width="580" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">
                                                                                        <p style="color: #164415;"><br style="font-family: lato, 'helvetica neue', helvetica, arial, sans-serif;"><span style="font-size: 16px; font-family: lato, 'helvetica neue', helvetica, arial, sans-serif;">Your developer works diligently to serve&nbsp;create ideas.<br>Looking forward to work with you in the future.<br><br><strong>I'll be in touch.</strong><br><br>Best regards,<br><span style="font-size:13px;">Justin Salas<br>dev@justinsalas.cc</span></span><br><br>&nbsp;<br><br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
